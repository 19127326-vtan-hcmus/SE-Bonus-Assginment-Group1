...
class __Mustache_5e1ac49b35ea89b50a302c0d8b378b1a extends Mustache_Template
{
...
';
        ...
        $buffer .= '
';
        $buffer .= $indent . '    data-region="paaaaaon">
';
        $buffer .= $indent . '    <div class="aaaaaaaaa nav-link icon-no-margin"
';
