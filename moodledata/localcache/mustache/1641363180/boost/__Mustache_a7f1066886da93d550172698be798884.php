...
class __Mustache_a7f1066886da93d550172698be798884 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<aaa class="container-fluid mb-2">
';
...
';
        ...
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <aaaa class="col-xs-6">
';
        // 'gradeessays' section
