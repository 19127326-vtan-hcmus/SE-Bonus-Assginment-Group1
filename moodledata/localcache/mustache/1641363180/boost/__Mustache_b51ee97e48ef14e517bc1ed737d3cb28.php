...
class __Mustache_b51ee97e48ef14e517bc1ed737d3cb28 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF47adaef4e5571cf8fae03a7250d3507($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section47a5a38f7f92b45aa35c684437dcead2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                if ($partial = $this->mustache->loadPartial('core/button')) {
                    $buffer .= $partial->renderInternal($context, $indent . '                    ');
                }
                $context->pop();
            }
    ...
    private function sectionF47adaef4e5571cf8fae03a7250d3507(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                // 'button' section
                $value = $context->find('button');
                $buffer .= $this->section47a5a38f7f92b45aa35c684437dcead2($context, $indent, $value);
                $context->pop();
            }
        }
